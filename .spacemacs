...
you should place your code here."
  ...
  (setq-default evil-escape-key-sequence "ii") ;; Has stopped working. Probably because lispyville
...
(custom-set-variables
 ...
 '(nrepl-message-colors
   '("#CC9393" "#DFAF8F" "#F0DFAF" "#7F9F7F" "#BFEBBF" "#93E0E3" "#94BFF3" "#DC8CC3"))
 '(package-selected-packages
   '(zoom yasnippet-snippets yaml-mode xkcd web-beautify vimrc-mode unicode-fonts ucs-utils font-utils typed-clojure-mode twittering-mode toml-mode system-packages symon stickyfunc-enhance srefactor spotify spaceline-all-the-icons smart-mode-line rich-minority sayid racer powershell pippel pipenv persp-projectile perspective persistent-soft list-utils password-generator overseer org-brain nov esxml nameless mvn meghanada md4rd tree-mode maven-test-mode magit-svn lsp-ui lsp-python lsp-javascript-typescript typescript-mode lsp-java livid-mode skewer-mode lispyville kotlin-mode kibit-helper json-navigator hierarchy json-mode json-snatcher json-reformat js2-refactor js2-mode js-doc intero importmagic impatient-mode hlint-refactor hindent parent-mode highlight-indent-guides helm-xref helm-spotify-plus multi helm-rtags helm-purpose window-purpose imenu-list helm-hoogle helm-fuzzier haskell-snippets groovy-mode groovy-imports pcache gradle-mode google-this google-c-style gmail-message-mode ham-mode html-to-markdown geiser fsharp-mode focus flymd flycheck-rust flycheck-rtags flycheck-kotlin flycheck-joker flycheck-haskell flycheck-elm flycheck-clojure flx evil-string-inflection string-inflection evil-snipe evil-org evil-lispy lispy zoutline evil-lion evil-goggles evil-cleverparens anzu engine-mode emojify ht elm-mode elfeed-web elfeed-org elfeed-goodies ace-jump-mode elfeed editorconfig edit-server disaster dimmer dante lcr dactyl-mode crux counsel-projectile counsel swiper ivy company-tern tern company-rtags rtags company-quickhelp company-lsp lsp-mode company-jedi jedi-core python-environment epc ctable concurrent deferred company-ghci company-ghc ghc haskell-mode company-cabal company-c-headers command-log-mode cmm-mode clomacs simple-httpd clojure-cheatsheet clang-format cider-hydra sesman pkg-info centered-cursor-mode cargo rust-mode browse-at-remote packed atomic-chrome websocket adoc-mode markup-faces popup diminish bind-map company-emacs-eclim eclim yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode helm-pydoc cython-mode company-anaconda anaconda-mode pythonic doom-themes all-the-icons memoize nyan-mode proof-general company-coq company-math math-symbol-lists ibuffer-projectile zenburn-theme zen-and-art-theme white-sand-theme underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme toxi-theme tao-theme tangotango-theme tango-plus-theme tango-2-theme sunny-day-theme sublime-themes subatomic256-theme subatomic-theme spacegray-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme seti-theme reverse-theme rebecca-theme railscasts-theme purple-haze-theme professional-theme planet-theme phoenix-dark-pink-theme phoenix-dark-mono-theme organic-green-theme omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme noctilux-theme naquadah-theme mustang-theme monokai-theme monochrome-theme molokai-theme moe-theme minimal-theme material-theme majapahit-theme madhat2r-theme lush-theme light-soap-theme jbeans-theme jazz-theme ir-black-theme inkpot-theme heroku-theme hemisu-theme hc-zenburn-theme gruvbox-theme gruber-darker-theme grandshell-theme gotham-theme gandalf-theme flatui-theme flatland-theme farmhouse-theme exotica-theme espresso-theme dracula-theme django-theme darktooth-theme autothemer darkokai-theme darkmine-theme darkburn-theme dakrone-theme cyberpunk-theme color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized clues-theme cherry-blossom-theme busybee-theme bubbleberry-theme birds-of-paradise-plus-theme badwolf-theme apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes afternoon-theme rainbow-mode rainbow-identifiers color-identifiers-mode selectric-mode typit mmt sudoku pacmacs dash-functional 2048-game emoji-cheat-sheet-plus company-emoji iedit scroll-restore play-crystal inf-crystal flycheck-crystal crystal-mode helm-company helm-c-yasnippet fuzzy company-web web-completion-data company-statistics clojure-snippets auto-yasnippet ac-ispell xterm-color shell-pop org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download multi-term htmlize gnuplot eshell-z eshell-prompt-extras esh-help powerline bind-key smartparens highlight f evil goto-chg projectile epl avy ghub let-alist async hydra dash s noflet ensime company sbt-mode scala-mode web-mode tagedit slim-mode scss-mode sass-mode pug-mode less-css-mode helm-css-scss haml-mode emmet-mode ahk-mode mips-mode ac-cider auto-complete smooth-scroll key-chord clj-refactor inflections edn multiple-cursors paredit yasnippet peg cider-eval-sexp-fu cider seq queue clojure-mode helm helm-core racket-mode faceup smeargle reveal-in-osx-finder pbcopy osx-trash osx-dictionary orgit mmm-mode markdown-toc markdown-mode magit-gitflow launchctl helm-gitignore gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gh-md flyspell-correct-helm flyspell-correct flycheck-pos-tip pos-tip flycheck evil-magit magit magit-popup git-commit with-editor diff-hl auto-dictionary ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint info+ indent-guide hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-themes helm-swoop helm-projectile helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu elisp-slime-nav dumb-jump define-word column-enforce-mode clean-aindent-mode auto-highlight-symbol auto-compile aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line))
